    ...
    <section class="detail-content">
        <div class="detail-materials">
            ...
            <div class="detail-materials-box clearfix">
                <h3>主料</h3>
                <ul>
                    <li class="" v-for="item of info.raw_material.main_material">
                        {{item.name}}
            ...
            <div class="detail-materials-box clearfix">
                <h3>辅料</h3>
                <ul>
                    <li class="" v-for="item of info.raw_material.accessories_material">
                        {{item.name}}
                        <span>{{item.specs}}</span>
                    </li>
                </ul>
        ...
        <div class="detail-explain">
            <h2>菜的做法</h2>
            <section class="detail-section clearfix" v-for="(item,index) of info.steps" >
                <em class="detail-number">{{index + 1}}.</em>
                <div class="detail-explain-desc">
                    <p>{{item.describe}}</p>
                    <img class="conimg" alt="" :src="item.img_url"/>
                </div>
            </section>
            <div class="skill">
                <h2>烹饪技巧</h2>
